package com.htet.employeemanagementapi.repositories.base;
...
public class BaseRepoImpl<T, ID> extends SimpleJpaRepository<T, ID> implements BaseRepository<T, ID> {
